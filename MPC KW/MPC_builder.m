...
addpath('C:\Users\Krisztian\Documents\GitHub\Waterlab setup\CasAdi') 
import casadi.*
...
objective = sumsqr(U) + 10000*sumsqr(S) + 1000*(Kt/dt_MPC)*sumsqr(X(1:Nxt,2:end) - X_ref); %+ 1*(Kt/dt_MPC)*sumsqr(X(1:Nxt,2:end) - [2;2]);                       
