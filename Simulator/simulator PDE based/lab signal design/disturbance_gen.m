...
%% create d_r -> reverse engineering

% d_r_1_temp = D_sim(1,:) - (1.2*resample(d_t1_WW(1,1:55000),4,1))
% d_r_1 = d_r_1_temp(1:20:200000);
% 
% d_r = [d_r_1; zeros(1,10000); zeros(1,10000)]
% %%
% save('d_r','d_r')
% 
% %%
...
% plot(D_sim(1,:))
% hold on
% plot(1.2*resample(d_t1_WW(1,:),4,1))
% 
% figure
% plot(D_sim(3,:))
