X_ref_t1_values = [2,2.5,3,4,5,6,5,4,3,2.5,4,6,5,4,3,2.5,3,5,4];
X_ref_t2_values = [2,2.5,3,3,4,5,5,6,6,5,4,3,2.5,3,5,6,4,2.5,3];
...
%X_ref_sim = resample([X_ref_t1; X_ref_t2]',4,1)';
X_ref_sim = resample([X_ref_t1; X_ref_t2]',1,1)';

%save() X_ref_sim for lab
