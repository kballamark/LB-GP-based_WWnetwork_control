...
W_x = 10;
W_u = [8,0; 0,4]; 
W_s = [20,0,0,0; 0,40,0,0; 0,0,20,0; 0,0,0,40]*10;  
W_o = 1000;
...
objective_all = W_x*hV*(0.0005/2*sumsqr(mu_X(1:Nxt,2:end)) + 0.0000001*objective_sigma) + sumsqr(W_u*dU) + hV*sumsqr(W_s*XI) + W_o*hV*sumsqr(EPS);    
